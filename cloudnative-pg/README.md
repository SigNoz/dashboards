...
It is built on the native `cnpg_*` metrics that each CloudNativePG instance exposes on its metrics endpoint (`:9187/metrics`), scraped via the OpenTelemetry Collector Prometheus receiver.
