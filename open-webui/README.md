...
Total inbound HTTP requests (FastAPI server spans) handled by the selected Open WebUI services over the selected time range. A quick pulse on overall traffic.

<img width="719" height="245" alt="open-webui-total-requests" src="./images/openwebui-panel-01.webp" />
...
<img width="719" height="245" alt="open-webui-error-rate" src="./images/openwebui-panel-02.webp" />
...
<img width="719" height="245" alt="open-webui-latency-p95" src="./images/openwebui-panel-03.webp" />
...
<img width="719" height="245" alt="open-webui-latency-p99" src="./images/openwebui-panel-04.webp" />
...
<img width="1442" height="491" alt="open-webui-request-rate-by-endpoint" src="./images/openwebui-panel-05.webp" />
...
<img width="1442" height="491" alt="open-webui-latency-percentiles" src="./images/openwebui-panel-06.webp" />
...
<img width="1442" height="491" alt="open-webui-error-rate-over-time" src="./images/openwebui-panel-07.webp" />
...
<img width="1457" height="491" alt="open-webui-request-distribution-by-endpoint" src="./images/openwebui-panel-08.webp" />
...
<img width="2888" height="491" alt="open-webui-endpoint-performance" src="./images/openwebui-panel-09.webp" />
...
<img width="1442" height="492" alt="open-webui-db-query-latency" src="./images/openwebui-panel-10.webp" />
...
<img width="1442" height="492" alt="open-webui-database-operations" src="./images/openwebui-panel-11.webp" />
...
<img width="719" height="244" alt="open-webui-llm-requests" src="./images/openwebui-panel-12.webp" />
...
<img width="719" height="244" alt="open-webui-input-tokens" src="./images/openwebui-panel-13.webp" />
...
<img width="719" height="244" alt="open-webui-output-tokens" src="./images/openwebui-panel-14.webp" />
...
<img width="734" height="244" alt="open-webui-total-cost" src="./images/openwebui-panel-15.webp" />
...
<img width="1442" height="492" alt="open-webui-llm-latency-percentiles" src="./images/openwebui-panel-16.webp" />
...
<img width="1442" height="492" alt="open-webui-token-usage-over-time" src="./images/openwebui-panel-17.webp" />
...
<img width="1442" height="492" alt="open-webui-llm-cost-over-time" src="./images/openwebui-panel-18.webp" />
...
<img width="1442" height="492" alt="open-webui-requests-by-model" src="./images/openwebui-panel-19.webp" />
...
<img width="2903" height="492" alt="open-webui-model-breakdown" src="./images/openwebui-panel-20.webp" />
...
<img width="2888" height="491" alt="open-webui-errors-over-time-by-service" src="./images/openwebui-panel-21.webp" />
...
<img width="1442" height="491" alt="open-webui-recent-error-traces" src="./images/openwebui-panel-22.webp" />
...
<img width="1442" height="491" alt="open-webui-recent-logs" src="./images/openwebui-panel-23.webp" />
